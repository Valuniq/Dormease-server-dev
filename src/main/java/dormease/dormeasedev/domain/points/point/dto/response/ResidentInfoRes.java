...
public class ResidentInfoRes {
    ...
    @Schema(type = "String", example = "건물명(인실)", description= "사생이 거주하는 건물의 이름입니다.")
    private String dormitoryName;

    @Schema(type = "String", example = "4인실", description = "해당 사생이 거주하는 건물의 인실입니다.")
    ...
    @Builder
    public ResidentInfoRes(Long id, String name, String studentNumber, String phoneNumber, Integer bonusPoint, Integer minusPoint, String dormitoryName, Integer roomSize, Integer room) {
        this.id = id;
        this.name = name;
