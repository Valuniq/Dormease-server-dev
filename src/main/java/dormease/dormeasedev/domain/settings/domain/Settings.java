package dormease.dormeasedev.domain.settings.domain;
...
public class Settings extends BaseEntity {
    ...
    @Builder
    public Settings(Long id, School school, Boolean isSmokedOn, Boolean isPrioritySelectionOn, Boolean isMoveSelectionOn, Boolean isSameTermOn, Boolean isPointOn, String agreementContent) {
        this.id = id;
        this.school = school;
