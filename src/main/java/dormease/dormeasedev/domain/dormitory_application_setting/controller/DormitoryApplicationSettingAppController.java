...
import dormease.dormeasedev.domain.dormitory_application_setting.service.DormitoryApplicationSettingAppService;
...
@Tag(name = "APP - Dormitory Appliation Setting API", description = "APP - 입사 신청 설정 관련 API입니다.")
