package dormease.dormeasedev.domain.dormitory_applications.meal_ticket.controller;
...
public class MealTicketAppController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "식권 목록 조회 실패", content = {@Content(mediaType = "application/json", schema = @Schema(implementation = ExceptionResponse.class))}),
    })
    @GetMapping
