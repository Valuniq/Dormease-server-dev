...
public class DormitoryApplicationAppController {
    ...
    public ResponseEntity<?> dormitoryApplication(
        ...
        return dormitoryApplicationService.dormitoryApplication(userDetailsImpl, dormitoryApplicationReq);
    }
    ...
    public ResponseEntity<?> findMyDormitoryApplication(
        ...
        return dormitoryApplicationService.findMyDormitoryApplication(userDetailsImpl);
    }
    ...
    public ResponseEntity<?> findMyDormitoryApplicationHistory(
        ...
        return dormitoryApplicationService.findMyDormitoryApplicationHistory(userDetailsImpl);
    }
    ...
    public ResponseEntity<?> findDormitoryApplication(
        ...
        return dormitoryApplicationService.findDormitoryApplication(userDetailsImpl, dormitoryApplicationId);
    }
    ...
    public ResponseEntity<?> acceptMovePass(
        ...
        return dormitoryApplicationService.acceptMovePass(userDetailsImpl);
    }
    ...
    public ResponseEntity<?> rejectMovePass(
        ...
        return dormitoryApplicationService.rejectMovePass(userDetailsImpl);
    }
